...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default="/data/liwenxi/agent/GenVideo/video_mme_swift")
    parser.add_argument("--video_dir", default="/data/liwenxi/agent/GenVideo/video_mme_videos")
